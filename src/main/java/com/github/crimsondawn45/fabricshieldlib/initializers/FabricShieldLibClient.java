...
public class FabricShieldLibClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        if(FabricLoader.getInstance().isDevelopmentEnvironment()) {
            // Will be made by player (dev code)
            EntityModelLayerRegistry.registerModelLayer(FabricShieldLib.fabric_shield_model_layer, FabricShieldEntityModel::getTexturedModelData);
