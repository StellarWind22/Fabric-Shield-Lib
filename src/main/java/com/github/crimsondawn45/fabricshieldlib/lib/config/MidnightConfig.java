...
public abstract class MidnightConfig {
    ...
    private static void initClient(String modid, Field field, EntryInfo info) {
        ...
        if (e != null) {
            ...
            if (type == int.class) textField(info, Integer::parseInt, INTEGER_ONLY, (int) e.min(), (int) e.max(), true);
                ...
                Function<Object, Text> func = value -> Text.translatable("text.autoconfig." + modid + ".option.enum." + type.getSimpleName() + "." + info.value.toString());
                info.widget = new AbstractMap.SimpleEntry<ButtonWidget.PressAction, Function<Object, Text>>(button -> {
    ...
    public static class MidnightConfigScreen extends Screen {
        //Replace translation keys here for the sake of localizations' backwards-compatibility
        protected MidnightConfigScreen(Screen parent, String modid) {
            super(Text.translatable("text.autoconfig." + modid + "title"));
            this.parent = parent;
            this.modid = modid;
            this.translationPrefix = "text.autoconfig." + modid + ".option.";
        }
