...
The [example mod repo](https://github.com/CrimsonDawn45/Fabric-Shield-Lib-Example-Mod/tree/1.15) is a template repo you can use to quickly get started if your making a new mod.
